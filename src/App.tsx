      ...
      <div className="max-w-6xl mx-auto px-4 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="mt-4 text-xs text-slate-500">
            To inicjatywa społeczna — nie zbieramy składek, tylko głosy, pomysły i energię do działania.
          </p>
        </div>
...
function QuickStats() {
  const staty = [
    { icon: Users, label: "Liczba mieszkańców", value: "~18 tys.", note: "Szacunek — do potwierdzenia na podstawie danych GUS / ewidencji ludności." },
